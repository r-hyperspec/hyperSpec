...
If you use package **hyperSpec** with data formats not mentioned in this document, please open a [new issue](https://github.com/r-hyperspec/hyperSpec/issues){target="_blank"} in **hyperSpec**'s GitHub repository so that this document can be updated.
...
To run the code examples, create a folder named "fileio" in your working directory and copy the contents of the directory <https://github.com/r-hyperspec/hyperSpec/tree/cbeleites/Vignettes/fileio>.
...
In that case, please contact the package maintainer ([**hyperSpec**'s GitHub repository](https://github.com/r-hyperspec/hyperSpec/issues){target="_blank"}) for advise (contributions to package **hyperSpec** are welcome and all authors are listed appropriately in the function help page's author section).
...
Anyone knowing where it moved please contact me ([**hyperSpec**'s GitHub repository](https://github.com/r-hyperspec/hyperSpec/issues){target="_blank"}) --- I'm looking for a reasonably official website (i.e. at Thermo) rather than some random site with a copy.
```
...
If you come across such files, please contact the package maintainer ([**hyperSpec**'s GitHub repository](https://github.com/r-hyperspec/hyperSpec/issues){target="_blank"}).
